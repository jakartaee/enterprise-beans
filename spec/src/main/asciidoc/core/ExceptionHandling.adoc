...
results in a checked exception{empty}footnote:a10285[A checked exception is one 
...
the _javax.ejb.EJBException_{empty}footnote:a10286[If the business interface 
