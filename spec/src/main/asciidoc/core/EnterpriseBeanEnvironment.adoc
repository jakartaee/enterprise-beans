...
entry may override an EJB annotation are described in <<a3912>>. 
...
are included in the _Web Services for Java EE_ specification<<a9879>>.
...
are described in the EJB Optional Features document <<a9890>>.] or Session.
