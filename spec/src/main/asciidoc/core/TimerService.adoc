...
beansfootnote:a10332[The calendar-based timer and non-persistent timer 
functionality is not supported for 2.1 Entity beans.]. Timers cannot be 
created for stateful session beansfootnote:a10333[This functionality may 
...
calledfootnote:a10334[In the event of race conditions, extraneous calls 
...
Stringfootnote:a10335[Note that annotation `java.lang.String` attributes 
...
namefootnote:a10339[If the bean implements the `TimedObject` interface, the 
