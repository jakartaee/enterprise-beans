...
functionality of the Java IDL and RMI packages that are part of the
Java SE platform.
...
RMI. Non-remote objects must be passed by value.
...
for passing arguments conforms to Java RMI.
