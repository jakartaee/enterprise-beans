...
the invoked method has the _REQUIRED_{empty}footnote:a10264[In this chapter we 
...
T1{empty}footnote:a10277[T2 if the method is an asynchronous method.]
...
An entity
object{empty}footnote:a10279[See <<a1702>>.] may be accessed by multiple 
clients in the
