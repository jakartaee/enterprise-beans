...
optionalfootnote:a10327[If the Bean Provider and Application Assembler do 
...
entityfootnote:a10328[Component contract and client view of entity beans 
...
entityfootnote:a10329[Component contract and client view of entity beans 
...
_javax.ejb.EJBAccessException_footnote:a10330[If the business interface 
...
different security policyfootnote:a10331[For example, the enterprise 
