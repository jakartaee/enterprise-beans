...
The method arguments and return value types of a home method on the remote home interface must be legal types for Java RMI.
...
The Enterprise Beans architecture allows a primary key class to be any class that is a legal Value Type in Java RMI, subject to the restrictions defined in <<a1725>> and <<a3011>>.
